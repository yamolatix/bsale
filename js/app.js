...
async function allProducts() {
    let result = await axios.get('https://desafio-bsale-back.onrender.com/api/products')
    return result.data
};
...
async function searchProducts(name) {
    try {
        let result = await axios.get(`https://desafio-bsale-back.onrender.com/api/products/search/${name}`)
...
async function allCategories() {
    let result = await axios.get(`https://desafio-bsale-back.onrender.com/api/category`)
...
async function productsInCategories(id) {
    let result = await axios.get(`https://desafio-bsale-back.onrender.com/api/category/${id}`)
